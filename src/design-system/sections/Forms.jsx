        ...
        <Block title="Text field — all states" rule="Label above, helper below, 44 px control, 12 px radius.">
          ...
          <Spec
            rows={[
              ...
              ['Border', `1 px --ds-border-control (${ratio(INK.borderControl, SURFACE.surface)}) at every state, focus included`],
              ['Focus ring', '2 px --ds-focus, 2 px offset — the same ring as every other control'],
